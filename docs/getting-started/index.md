...
- :lucide-braces:{ .lg .middle } **Developer**
  ...
  ***
  ...
  [:octicons-arrow-right-24: Development Setup](installation.md)
...
1. **[Quick Start](quick-start.md)** - Get using ShopSync immediately
2. **[Installation](installation.md)** - Set up the development environment
3. **[Firebase Setup](firebase-setup.md)** - Configure Firebase for your project
