...
- :material-lightbulb-on:{ .lg .middle } **Smart Suggestions**
  ...
  ***
  ...
  [:octicons-arrow-right-24: Discover Features](features/smart-suggestions.md)
...
=== "Web App"
    ...
    Visit [app.shopsync.aadish.dev](https://app.shopsync.aadish.dev) to start using ShopSync instantly in your browser.
...
- **GitHub**: [ASDev-Official/ShopSync](https://github.com/ASDev-Official/ShopSync)
- **Localization**: [Crowdin Project](https://crowdin.com/project/as-shopsync)
- **Issues**: [Report a Bug](https://github.com/ASDev-Official/ShopSync/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ASDev-Official/ShopSync/discussions)
...
[Install ShopSync](getting-started/installation.md){ .md-button .md-button--primary }
